...
import java.awt.image.*;
 ...
 public class max extends JPanel{
   ...
   static String imageName2; 
    ...
    public static void main(String args[]) throws Exception {
    	...
    	//int k=5;
    	 ...
    	 c[7]=5;
    	 c[8]=7;
    	  n[0]="C:\\BORLANDC\\BIN\\muneco.bmp";
    	  n[1]="C:\\BORLANDC\\BIN\\CIMG1098.bmp";
    	 // n[1]="C:\\BORLANDC\\BIN\\sd";
    	    ...
    	    ventana.getContentPane().add( new max(n),BorderLayout.CENTER );
