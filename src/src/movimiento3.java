...
public class movimiento3 extends JPanel {
	...
	static ActionListener act;
	  public movimiento3(String nombre3){
		 // add(texto);
		 t=2;
	...
	public static void main(String[] args) {
	    ...
	    ventana.getContentPane().add( new movimiento3(),BorderLayout.CENTER );
