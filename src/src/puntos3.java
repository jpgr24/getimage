...
import java.awt.image.*;
 ...
 public class puntos3 extends JPanel{
    ...
    public static void main(String args[]) throws Exception {
    	...
    	//int k=5;
    	 ...
    	 // n[1]="C:\\BORLANDC\\BIN\\sd";
    	    ...
    	    ventana.getContentPane().add( new puntos3(n[0]),BorderLayout.CENTER );
